...
namespace Circle.Frontends.Web.Infrastructure.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddHttpClients(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddHttpClient<IOperationClaimService, OperationClaimService>(s =>
            {
                s.BaseAddress = new Uri(configuration.GetValue<string>("ApiUrl"));
            }).AddHttpMessageHandler<ResourceOwnerPasswordTokenHandler>();

            services.AddHttpClient<IGroupClaimService, GroupClaimService>(s =>
            {
                s.BaseAddress = new Uri(configuration.GetValue<string>("ApiUrl"));
            }).AddHttpMessageHandler<ResourceOwnerPasswordTokenHandler>();
            ...
            services.AddHttpClient<ILanguageService, LanguageService>(s =>
            {
                s.BaseAddress = new Uri(configuration.GetValue<string>("ApiUrl"));
            }).AddHttpMessageHandler<ResourceOwnerPasswordTokenHandler>();

            services.AddHttpClient<ICategoryService, CategoryService>(s =>
            {
                s.BaseAddress = new Uri(configuration.GetValue<string>("ApiUrl"));
            }).AddHttpMessageHandler<ResourceOwnerPasswordTokenHandler>();

            services.AddHttpClient<IProductService, ProductService>(s =>
            {
                s.BaseAddress = new Uri(configuration.GetValue<string>("ApiUrl"));
            }).AddHttpMessageHandler<ResourceOwnerPasswordTokenHandler>();

            services.AddHttpClient<IProductDetailService, ProductDetailService>(s =>
            {
                s.BaseAddress = new Uri(configuration.GetValue<string>("ApiUrl"));
            }).AddHttpMessageHandler<ResourceOwnerPasswordTokenHandler>();

            services.AddHttpClient<ICategoryAttributeService, CategoryAttributeService>(s =>
            {
                s.BaseAddress = new Uri(configuration.GetValue<string>("ApiUrl"));
            }).AddHttpMessageHandler<ResourceOwnerPasswordTokenHandler>();
        }
