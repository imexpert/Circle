...
namespace Circle.Library.DataAccess.Migrations.Ms
{
    ...
    [Migration("20211001201905_InitialCreate2")]
            ...
            modelBuilder.Entity("Circle.Core.Entities.Concrete.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("61a61d63-e656-4ed5-9ca8-8dad3b670707"),
                            Code = "tr-TR",
                            Ip = "1:1",
                            Name = "Türkçe",
                            RecordDate = new DateTime(2021, 10, 1, 23, 19, 4, 741, DateTimeKind.Local).AddTicks(2686),
                            RecordUsername = "admin",
                            UpdateDate = new DateTime(2021, 10, 1, 23, 19, 4, 743, DateTimeKind.Local).AddTicks(8441),
                            UpdateUsername = "admin"
                        },
                        new
                        {
                            Id = new Guid("173cca8e-9bd1-41c0-a163-9648e7769f0c"),
                            Code = "en-US",
                            Ip = "1:1",
                            Name = "English",
                            RecordDate = new DateTime(2021, 10, 1, 23, 19, 4, 743, DateTimeKind.Local).AddTicks(9153),
                            RecordUsername = "admin",
                            UpdateDate = new DateTime(2021, 10, 1, 23, 19, 4, 743, DateTimeKind.Local).AddTicks(9169),
                            UpdateUsername = "admin"
                        });
                });
