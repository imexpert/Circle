...
namespace Circle.Library.DataAccess.Migrations.Ms
{
    ...
    [Migration("20211001202121_UserGroupDuzenlendi")]
    partial class UserGroupDuzenlendi
    {
            ...
            modelBuilder.Entity("Circle.Core.Entities.Concrete.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47551c83-25c7-47f5-9ba4-20015ecfc439"),
                            Code = "tr-TR",
                            Ip = "1:1",
                            Name = "Türkçe",
                            RecordDate = new DateTime(2021, 10, 1, 23, 21, 20, 890, DateTimeKind.Local).AddTicks(5367),
                            RecordUsername = "admin",
                            UpdateDate = new DateTime(2021, 10, 1, 23, 21, 20, 892, DateTimeKind.Local).AddTicks(5050),
                            UpdateUsername = "admin"
                        },
                        new
                        {
                            Id = new Guid("22f9b20e-f4d5-42f5-a88f-7f9a6d283c5f"),
                            Code = "en-US",
                            Ip = "1:1",
                            Name = "English",
                            RecordDate = new DateTime(2021, 10, 1, 23, 21, 20, 892, DateTimeKind.Local).AddTicks(5619),
                            RecordUsername = "admin",
                            UpdateDate = new DateTime(2021, 10, 1, 23, 21, 20, 892, DateTimeKind.Local).AddTicks(5632),
                            UpdateUsername = "admin"
                        });
                });
