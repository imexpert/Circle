...
namespace Circle.Web.Helper.Extensions
{
    public static class StringExtensions
    {
        ...
        public static bool IsNumeric(this string str)
        {
            ...
            long retNum;
            return long.TryParse(str, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out retNum);
        }
        ...
        public static long ToLong(this string str)
        {
            ...
            long tmp = 0;
            if (long.TryParse(str, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out tmp))
                return tmp;
            else
                return 0;
        ...
        public static int ToInt(this string str)
        {
            ...
            int tmp;
            if (int.TryParse(str, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out tmp))
                return tmp;
            else
                return 0;
        ...
        public static double ToDouble(this string str)
        {
            ...
            double tmp;
            if (double.TryParse(str, NumberStyles.Float, NumberFormatInfo.InvariantInfo, out tmp))
                return tmp;
            else
                return 0.0;
